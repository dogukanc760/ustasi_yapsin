...
import 'package:ustasi_yapsin/screens_service_provider/isin_yapildigini_onayla_hv.dart';
...
class _ProfilIcerikState extends State<ProfilIcerik> {
  ...
  Future<void> getDemands() async {
    ...
    final response = await http.get(
      Uri.parse('https://ustasiyapsin-api.herokuapp.com/api/demand/' +
          widget.demandId),
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                    demandDetail[0].location[0][1].toString() +
                                        '/' +
                                        demandDetail[0]
                                            .location[0][0]
                                            .toString(),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: Padding(
                                padding: const EdgeInsets.fromLTRB(3, 10, 0, 0),
                                child: Text('Hizmet Verenler Arayabilir',
                                    style: TextStyle(
                                        color: Colors.grey.shade500,
                                        fontWeight: FontWeight.bold,
                                        fontSize: 12)),
