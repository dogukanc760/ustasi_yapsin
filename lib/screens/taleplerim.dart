                                ...
                                SizedBox(
                                  ...
                                  index==1 ? TextButton(
                                      onPressed: () {
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(builder: (context) => TalepDurumu(state: 4)),
                                        );
                                      },
                                      child:Text('1500 ₺',
                                  ...
                                  index%2==0 ? TextButton(
                                      onPressed: () {
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(builder: (context) => TalepDurumu(state: 1)),
                                        );
                                      },
                                  ...
                                  TextButton(
                                      onPressed: () {
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(builder: (context) => TalepDurumu(state: 2)),
                                        );
                                      },
                                      child: Text('1500 ₺',
                                          style: TextStyle(fontSize: 12 ,color: Colors.grey.shade500))),
