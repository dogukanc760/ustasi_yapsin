...
import 'hizmet_veren_profili_hv.dart';

class HizmetFotografHv extends StatefulWidget {
  const HizmetFotografHv({Key? key}) : super(key: key);

  @override
  _HizmetFotografState createState() => _HizmetFotografState();
}

class _HizmetFotografState extends State<HizmetFotografHv> {
  @override
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      'Müşterileriniz refaranslarınızı görmek istiyor. İşi tamamladığınızda en az 1 fotoğraf çekmelisiniz',
                  ...
                  child: FlatButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => HizmetVerenProfilHv()));
                      },
                      child: Text(
                        'Devam Et',
