...
import 'package:ustasi_yapsin/screens_service_provider/is_neden_iptal_edildi_hv.dart';
import 'package:ustasi_yapsin/screens/isin_yapildigini_onayla.dart';


import 'hizmetfotograf_hv.dart';

class TalepDurumuHv extends StatelessWidget {
  final int state;
  const TalepDurumuHv({required this.state}) : super();
